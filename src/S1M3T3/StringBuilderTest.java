...
public class StringBuilderTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("sb1的容量是" + sb1.capacity());     //16
        System.out.println("sb1的长度是" + sb1.length());       //0

        System.out.println("-----------------------------------------------------------");
        // 2.使用参数指定的容量来构造对象并打印容量和长度
        StringBuilder sb2 = new StringBuilder(20);
        System.out.println("sb2 = " + sb2);                     // 自动调用toString方法 啥也没有
        System.out.println("sb2的容量是" + sb2.capacity());     //20
        System.out.println("sb2的长度是" + sb2.length());       //0

        System.out.println("-----------------------------------------------------------");
        // 3.根据参数指定的字符串内容来构造对象并打印容量和长度
        StringBuilder sb3 = new StringBuilder("hello");
        System.out.println("sb3 = " + sb3);                     // 自动调用toString方法 hello
        System.out.println("sb3的容量是： " + sb3.capacity());   // 16 + 5 = 21
        System.out.println("sb3的长度是： " + sb3.length());     //5
        ...
        System.out.println("sb4 = " + sb4);     //helloabcd 返回调用对象自己的引用,也就是返回值和调用对象是同一个字符串
        System.out.println("sb3 = " + sb3);     //helloabcd

        // 向中间位置插入字符串"1234"
        sb3.insert(4,1234);
        System.out.println("sb3 = " + sb3);     // abcd1234hello
        System.out.println("sb4 = " + sb4);     //修改sb3,sb4也会变化因为指向同一个对象
        // 向末尾位置插入字符串"ABCD"
        ...
        sb3.delete(0,4);
        System.out.println("删除后的字符串是： " + sb3);     // 1234ABCDworld
        // 删除中间字符串
        sb3.delete(4,8);
        System.out.println("删除后的字符串是： " + sb3);     // 1234world
        // 删除末尾字符串
        sb3.delete(4,sb3.length());
        System.out.println("删除后的字符串是： " + sb3);     // 1234
        ...
        // 修改"234"为"bcd"
        sb3.replace(1,sb3.length(),"bcd");
        System.out.println("sb3 = " + sb3);             //abcd
        // 实现查找的功能
