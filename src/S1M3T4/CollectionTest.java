...
public class CollectionTest {
    ...
    public static void main(String[] args) {
        ...
        //Collections c1 = new Collection();    // 接口不能实例化，也就是不能创建对象
        ...
        */
        ...
        b1 = c1.remove(new Person("zhangfei",30));  //true
        //[2, three, 4]
        System.out.println("c1 = " + c1);
        ...
        System.out.println(c1.isEmpty() ? "空了" : "不空");
        System.out.println((0 == c1.size())? "空了" : "不空");
        // 清空集合中的所有元素
        c1.clear();
        ...
        System.out.println("数组中的元素有： " + Arrays.toString(objects)); //[1, 2]
